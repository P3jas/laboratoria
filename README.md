...
Optymalizacja: Połączono komendy apt-get update oraz apt-get install w jedną instrukcję RUN i dodano czyszczenie pamięci podręcznej. Zredukowało to liczbę warstw i zmniejszyło rozmiar końcowy obrazu.
